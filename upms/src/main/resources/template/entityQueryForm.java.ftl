...
<#if swagger2>
@ApiModel(value="${entity}QueryForm", description="${table.comment!}对外查询条件")
</#if>
<#if superEntityClass??>
public class ${entity}QueryForm extends BaseQueryForm<${entity}QueryParam> {
<#elseif activeRecord>
public class ${entity}QueryForm extends Model<${entity}> {
<#else>
public class ${entity}QueryForm implements Serializable {
</#if>
