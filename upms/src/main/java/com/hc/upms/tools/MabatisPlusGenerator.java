...
public class MabatisPlusGenerator {
    ...
    //生成文件所在项目路径
    private static String baseProjectPath = "D:\\ideaworkspace\\iris\\upms";

    //基本包名
    private static String basePackage = "com.hc";

    //作者
    private static String authorName = "auto";
    //要生成的表名
    private static String[] tables = {"t_sys_roles","t_sys_user_role"};    //table前缀
    private static String prefix = "t_";

    //数据库配置四要素
    private static String driverName = "com.mysql.cj.jdbc.Driver";
    private static String url = "jdbc:mysql://127.0.0.1:3306/iris?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC";
    ...
    public static void main(String[] args) {
        ...
        gen.setStrategy(new StrategyConfig()
                        ...
                        // 自定义实体父类
                        .setSuperEntityClass("com.hc.common.core.entity.po.BasePo")
                        // 自定义实体，公共字段
        ...
        fileOutList.add(new FileOutConfig("template/entity.java.ftl") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return baseProjectPath + "/src/main/java/com/hc/upms/entity/po/" + tableInfo.getEntityName() + ".java";
            }
        });
        fileOutList.add(new FileOutConfig("template/entityForm.java.ftl") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return baseProjectPath + "/src/main/java/com/hc/upms/entity/form/" + tableInfo.getEntityName() + "Form.java";
            }
        });
        fileOutList.add(new FileOutConfig("template/entityQueryForm.java.ftl") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return baseProjectPath + "/src/main/java/com/hc/upms/entity/form/" + tableInfo.getEntityName() + "QueryForm.java";
            }
        });
        fileOutList.add(new FileOutConfig("template/entityQueryParam.java.ftl") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return baseProjectPath + "/src/main/java/com/hc/upms/entity/param/" + tableInfo.getEntityName() + "QueryParam.java";
            }
        });
